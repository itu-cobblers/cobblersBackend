...
namespace cobblersBackend.Migrations
{
    ...
    [Migration("20260805080246_AddSubmissionFeedbackJson")]
    partial class AddSubmissionFeedbackJson
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("cobblersBackend.Data.Entities.Assignment", b =>
                {
                    ...
                    b.Property<string>("LessonJson")
                        .HasColumnType("jsonb")
                        .HasColumnName("lesson_json");
            ...
            modelBuilder.Entity("cobblersBackend.Data.Entities.Session", b =>
                {
                    ...
                    b.ToTable("session", null, t =>
                        {
                            t.HasCheckConstraint("ck_session_status", "status IN ('active', 'ended')");
                        });
                });
