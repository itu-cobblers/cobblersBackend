...
session-specific logic. That gate lives in the frontend; the backend returns
`SampleSolutionJson` whenever asked — via the dedicated solution route or
`includeSolution=true` on assignment-content routes. See [CONTRACT.md](CONTRACT.md#solution).
